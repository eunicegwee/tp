...
/**
 * Tests that a {@code Person}'s {@code Email} contains any of the given keywords.
 */
public class EmailContainsKeywordPredicate implements Predicate<Person> {
    ...
    public boolean equals(Object other) {
        ...
        EmailContainsKeywordPredicate otherPredicate = (EmailContainsKeywordPredicate) other;
